...
if (indicatorUnit === 'c') {
    ...
    console.log(`${fahrenheit} degrees in Fahrenheit is ${cTwoDecimals} degrees in Celsius.`
    );
} else if (indicatorUnit === 'k') {
    let kelvin = ((fahrenheit + 459.67) * 5) / 9;
    let kTwoDecimals = kelvin.toFixed(2);
    console.log(`${fahrenheit} degrees in Fahrenheit is ${kTwoDecimals} degrees in Kelvin.`
    );
} else {
